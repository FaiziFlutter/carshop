...
class TiresBuyNow extends StatefulWidget {
  const TiresBuyNow({super.key});

  @override
  State<TiresBuyNow> createState() => _TiresBuyNowState();
}

class _TiresBuyNowState extends State<TiresBuyNow> {
  int currentIndex = 0;
  var itemcount = 4;
