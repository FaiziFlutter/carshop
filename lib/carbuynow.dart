...
class CarsBuyNow extends StatefulWidget {
  const CarsBuyNow({super.key});

  @override
  State<CarsBuyNow> createState() => _CarsBuyNowState();
}

class _CarsBuyNowState extends State<CarsBuyNow> {
  int currentIndex = 0;
  var itemcount = 4;
                ...
                return Container(
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/blackjeep.jpg'),
                    ),
                  ),
                );
              },
